...
public class NoodleAdapter extends RecyclerView.Adapter<NoodleAdapter.ViewHolder> {
    ...
    public NoodleAdapter(Context context , List<String> food , List<String> path , List<String> price) {
